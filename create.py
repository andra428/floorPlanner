...
from selectRoom import UI_SelectRoomWindow

class UI_CreateWindow(object):

    def openSelectRoom1(self,createW):
        self.window = QtWidgets.QMainWindow()
        self.ui = UI_SelectRoomWindow(num_rooms=1)
    ...
    def openSelectRoom2(self,createW):
        self.window = QtWidgets.QMainWindow()
        self.ui = UI_SelectRoomWindow(num_rooms=2)
        self.ui.setupUi(self.window, createW)
        self.window.show()
        self.ui.goBack = createW
        createW.hide()
    ...
    def openSelectRoom3(self, createW):
        self.window = QtWidgets.QMainWindow()
        self.ui = UI_SelectRoomWindow(num_rooms=3)
        self.ui.setupUi(self.window, createW)
        self.window.show()
        self.ui.goBack = createW
        createW.hide()
