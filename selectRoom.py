...
from floorPlanner import FloorplannerApp

class UI_SelectRoomWindow(object):
    ...
    def openApartament1RoomBedroom(self, SelectW, nrr):
        ...
        self.ui = FloorplannerApp(room="bedroom", nr_rooms=nrr)
    ...
    def openApartament1RoomKitchen(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="kitchen", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1RoomBathroom(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="bathroom", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1RoomLivingRoom(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="LivingRoom", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1Corridor1(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="corridor1", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1Corridor2(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="corridor2", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1Corridor3(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="corridor3", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
    ...
    def openApartament1RoomBedroom2(self, SelectW, nrr):
        self.window = QtWidgets.QMainWindow()
        self.ui = FloorplannerApp(room="bedroom2", nr_rooms=nrr)
        self.ui.setupUi(self.window, SelectW)
        self.ui.goBack = SelectW
        self.ui.ui_select = self
        self.window.show()
